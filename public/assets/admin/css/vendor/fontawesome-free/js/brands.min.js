...
! function() {
    ...
    function V(c, h) {
        var l = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks,
            z = void 0 !== l && l,
            m = Object.keys(h).reduce(function(c, l) { var z = h[l]; return !!z.icon ? c[z.iconName] = z.icon : c[l] = z, c }, {});
        "function" != typeof H.hooks.addPack || z ? H.styles[c] = function(m) {
            for (var c = 1; c < arguments.length; c++) {
                var v = null != arguments[c] ? arguments[c] : {},
                    l = Object.keys(v);
                "function" == typeof Object.getOwnPropertySymbols && (l = l.concat(Object.getOwnPropertySymbols(v).filter(function(c) { return Object.getOwnPropertyDescriptor(v, c).enumerable }))), l.forEach(function(c) {
                    var l, z, h;
