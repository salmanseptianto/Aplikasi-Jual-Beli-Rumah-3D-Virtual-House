    ...
    function F() {
        ...
        var e = function(t) {
                for (var c = Array.from(u.scripts).filter(function(e) { return !e.hasAttribute(x) && e !== t }), a = {}, e = function(e) {
                        ...
                        }.toString(), ")('").concat(w, "', '").concat(o, "', '").concat(i, "');"), t.onload = function() { t.contentWindow.addEventListener("error", D, !0), t.contentDocument.head.appendChild(r), t.contentDocument.head.appendChild(n) }, m(function() { return u.body.appendChild(t) })
            ...
            o = function() {
                ...
                function n(e, t) {
                    ...
                    }.toString(), ")('").concat(w, "', '").concat(o || "foo", "', '").concat(t, "', '").concat(c, "');"), n.onload = function() { n.contentWindow.addEventListener("error", D, !0), n.contentDocument.head.appendChild(i), n.contentDocument.head.appendChild(e), n.contentDocument.body.appendChild(r) }, m(function() { return u.body.appendChild(n) })
                }
