...
(function(global, factory) {
            ...
            click: {
                ...
                setup: function(data) {
                    ...
                    if (rcheckableType.test(el.type) &&
                        ...
                        leverblogsative(el, "click", returnTrue);
                    }
    ...
    function leverblogsative(el, type, expectSync) {
    ...
    jQuery.each({ focus: "focusin", blur: "focusout" }, function(type, delegateType) {
        jQuery.event.special[type] = {
            ...
            setup: function() {
                ...
                leverblogsative(this, type, expectSync);
