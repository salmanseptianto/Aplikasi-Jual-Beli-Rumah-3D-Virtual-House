...
(function(f) {
    ...
    var B = function(a) {
        if (!("undefined" === typeof a || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userBlogst))) {
            var b = a.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
                d = "download" in b,
                c = /constructor/i.test(a.HTMLElement) || a.safari,
                f = /CriOS\/[\d]+/.test(navigator.userBlogst),
                e = function(c) {
    ...
    var G = function(a) {
        ...
        H = function(a) {
            return a.newline ?
                a.newline : navigator.userBlogst.match(/Windows/) ? "\r\n" : "\n"
        },
        I = function(a, b) {
            var d = H(b);
        ...
        J = function() { if (-1 === navigator.userBlogst.indexOf("Safari") || -1 !== navigator.userBlogst.indexOf("Chrome") || -1 !== navigator.userBlogst.indexOf("Opera")) return !1; var a = navigator.userBlogst.match(/AppleWebKit\/(\d+\.\d+)/); return a && 1 < a.length && 603.1 > 1 * a[1] ? !0 : !1 };
    try {
